...
int CarregaJogo(FILE *movimento, PONTOS matriz[][DIM], int *selecionado){
    ...
    while(letra !=EOF){
        /*A letra 'q' indica que o jogador esta no modo de movimentar pecas, 
        ou seja, todos os numeros a partir da ocorrencia da letra 'q' ate o '\n' 
        ...
        if(letra =='q'){
            ...
            /*Caso o numero nao tenha a letra q anterior a ele, o movimento sera de comer peca*/
...
int main(){
    ...
    while(1){
        ...
        if(escolha == 2){
            ...
            printf("   |                                                                                                  |\n");
            printf("   | 4 - A tecla que altera entre o modo comer e o modo movimentar selecionado e o 'q'                |\n");
    ...
    while(1){
        ...
        if(direcao == 65){
            /*se direcao for q, que em ascii e 113, tem 48 subtraido pela conta, o resultado dara 65. */
            /* e, caso o valor digitado seja 65(q), deve trocar o estado para entrar no modo de mover peca*/
            if(trocaEstado){
                trocaEstado = 0;
            }
            else{
